    ...
    <InfoBox className="infoBox">
      ...
      <p>
        * Все гимны, помеченные звёздочкой, были первоначально написаны на
        ...
        поток» (США). † Все гимны, помеченные крестиком, представляют собой
        сочинения различных авторов, переведённые на английский язык Уитнессом
        Ли и редакционным отделом служения «Живой поток» (США). Перед текстом
        каждого гимна указана размерность гимна и номер соответствующего гимна в
        английском сборнике, опубликованном служением «Живой поток» (номер
        указан в скобках).
      </p>
      <p>
